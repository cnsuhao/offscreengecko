...
//#define MAP_KEY(OSGKKey, GeckoDOMKey)
MAP_KEY(Backspace,  BACK_SPACE)
MAP_KEY(Tab,        TAB)
MAP_KEY(Return,     RETURN)
MAP_KEY(Shift,      SHIFT)
MAP_KEY(Control,    CONTROL)
MAP_KEY(Alt,        ALT)
MAP_KEY(CapsLock,   CAPS_LOCK)
...
MAP_KEY(F11,        F11)
MAP_KEY(F12,        F12)
MAP_KEY(NumLock,    NUM_LOCK)
MAP_KEY(ScrollLock, SCROLL_LOCK)
